...
<div class="wcf-menu-page-header">
	<div class="wcf-container wcf-flex">
		<div class="wcf-title">
			<span class="screen-reader-text"><?php echo esc_html( CARTFLOWS_NAME ); ?></span>
			<img class="wcf-logo" alt="" src="<?php echo esc_url( CARTFLOWS_URL . 'assets/images/cartflows-logo.svg' ); ?>" />
		</div>
